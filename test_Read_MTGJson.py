...
def test_mana_cost(test_read_card):
    ...
    assert test_read_card.find_mana_cost_symbol("W", ['10', 'W', 'U', 'W']) == 'WW', "Did not find W in ['10', 'W', 'U', 'W']"
    assert test_read_card.find_mana_cost_symbol("U", ['10', 'W', 'U', 'W']) == 'U', "Did not find U in ['10', 'W', 'U', 'W']"
    assert test_read_card.find_mana_cost_symbol("C", ['10', 'W', 'U', 'W']) == '', "Did not return blank searching for C in ['10', 'W', 'U', 'W']"
